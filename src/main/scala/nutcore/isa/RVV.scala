...
object RVVInstr extends HasInstrType with HasNutCoreParameter {
    ...
    val table = Array(
        ...
        VMULVV       -> List(InstrVV, FuType.vmdu, VXUOpType.mulvv),
        VMULVX       -> List(InstrVS, FuType.vmdu, VXUOpType.mulvx),
        VMULHVV      -> List(InstrVV, FuType.vmdu, VXUOpType.mulhvv),
        VMULHVX      -> List(InstrVS, FuType.vmdu, VXUOpType.mulhvx),
        VMULHUVV     -> List(InstrVV, FuType.vmdu, VXUOpType.mulhuvv),
        VMULHUVX     -> List(InstrVS, FuType.vmdu, VXUOpType.mulhuvx),
        VMULHSUVV    -> List(InstrVV, FuType.vmdu, VXUOpType.mulhsuvv),
        VMULHSUVX    -> List(InstrVS, FuType.vmdu, VXUOpType.mulhsuvx),
        VDIVVV       -> List(InstrVV, FuType.vmdu, VXUOpType.divvv),
        VDIVVX       -> List(InstrVS, FuType.vmdu, VXUOpType.divvx),
        VDIVUVV      -> List(InstrVV, FuType.vmdu, VXUOpType.divuvv),
        VDIVUVX      -> List(InstrVS, FuType.vmdu, VXUOpType.divuvx),
        VREMVV       -> List(InstrVV, FuType.vmdu, VXUOpType.remvv),
        VREMVX       -> List(InstrVS, FuType.vmdu, VXUOpType.remvx),
        VREMUVV      -> List(InstrVV, FuType.vmdu, VXUOpType.remuvv),
        VREMUVX      -> List(InstrVS, FuType.vmdu, VXUOpType.remuvx),
        
        VMADDVV      -> List(InstrVV, FuType.vmdu, VXUOpType.maddvv),
        VMADDVX      -> List(InstrVS, FuType.vmdu, VXUOpType.maddvx),
        VNMSUBVV     -> List(InstrVV, FuType.vmdu, VXUOpType.nmsubvv),
        VNMSUBVX     -> List(InstrVS, FuType.vmdu, VXUOpType.nmsubvx),
        VMACCVV      -> List(InstrVV, FuType.vmdu, VXUOpType.maccvv),
        VMACCVX      -> List(InstrVS, FuType.vmdu, VXUOpType.maccvx),
        VNMSACVV     -> List(InstrVV, FuType.vmdu, VXUOpType.nmsacvv),
        VNMSACVX     -> List(InstrVS, FuType.vmdu, VXUOpType.nmsacvx),
